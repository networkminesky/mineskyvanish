...
public class ServerListPacketListener extends PacketAdapter {
    ...
    public ServerListPacketListener(MineSkyVanish plugin) {
     ...
     */
    public ServerListPacketListener(MineSkyVanish plugin, boolean use_legacy) {
        //noinspection deprecation
        super(plugin, ListenerPriority.NORMAL, PacketType.Status.Server.OUT_SERVER_INFO);
        this.plugin = plugin;
    }

    public static void register(MineSkyVanish plugin) {
    ...
    public static boolean isEnabled(MineSkyVanish plugin) {
