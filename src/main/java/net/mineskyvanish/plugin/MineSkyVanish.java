...
import net.mineskyvanish.plugin.commands.VanishCommand;
import net.mineskyvanish.plugin.config.ConfigMgr;
import net.mineskyvanish.plugin.features.FeatureMgr;
import net.mineskyvanish.plugin.hooks.PluginHookMgr;
import net.mineskyvanish.plugin.listeners.*;
import net.mineskyvanish.plugin.utils.ExceptionLogger;
import net.mineskyvanish.plugin.utils.VersionUtil;
import net.mineskyvanish.plugin.visibility.ActionBarMgr;
import net.mineskyvanish.plugin.visibility.FileVanishStateMgr;
import net.mineskyvanish.plugin.visibility.ServerListPacketListener;
import net.mineskyvanish.plugin.visibility.VisibilityChanger;
import net.mineskyvanish.plugin.visibility.hiders.PreventionHider;
...
public class MineSkyVanish extends JavaPlugin implements MineSkyVanishPlugin {
    ...
    public void onEnable() {
        try {
            ...
            if (!useProtocolLib) log(Level.INFO,
                    "Please install ProtocolLib to be able to use all MineSkyVanish features: " +
